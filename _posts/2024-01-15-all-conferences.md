...
Here's a list of all the research and/or practice-oriented festivals/conferences I have either attended in full or presented at over the past few years. I might have forgotten a few, but I've added the ones where I either have presented a talk, and/or have joined a workshop or event (or it was particularly memorable). The grouping of 'festival' and 'conference' is semantic, but they generally involve research and technology ([in a broad sense](https://www.ursulakleguin.com/a-rant-about-technology)). There are a few exceptions to this: The Turing Way's Fireside Chats from 2022 and 2023 (which I organised alongside many others), as well as our bi-annual Book Dashes. These are quite different events (especially as an organiser), and I'd like to write about them separately.

Listing all of these events took me across a few different mediums: from twitter (when I used it as a public note-taking tool) to youtube, to personal notes and more. I've linked a few, if anything for myself. This was a really useful exercise, as it put into perspective how far I've come over the past few years (and also, how much *tacit* knowledge I learned in each of these spaces).

Most of the talks I enjoyed giving involved working alongside someone else – 
...
| HOT Summit | Nov 2021 | 💻 - remote | This was the first time I shared my MA research _with_ the OpenStreetMap (or in this case, the humanitarian mapping) community. The reaction I received at the time . I remember feeling nervous about how they would react to this critical work, but happy that anthropological studies were getting out. I had looked to other social science researchers like [Martin Dittus]() and [David Garcia](), who had presented their work in 
...
| Research for Genomics Equity | Oct 2022 | 🏛️ - in-person | I remember feeling like I knew nothing about data in the health context, and learned a lot from. It was a pleasure to collorate, and to experiment with what it means to bring people together collaboratively in a physical space (something I hadn't done in quite a long time). 
...
| Global Dynamics in Responsible Research Virtual Symposium | Dec 2022 | This was the first time I had
| Duham RIOT Science Club | Dec 2022 | 💻 - remote |
...
| Riot Science | Jul 2023 |  | Gave this talk with Batool Almarzouq - 
...
**I didn't realise how important fellowships can be for inspiration and for career growth (or even networking). This has absolutely been the case for me, and I'm definitely planning to write another blog about this.
...
**2. The cadence of conferences really changed post-pandemic, and it took us awhile to find our footing again.**
